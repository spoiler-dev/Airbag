  ...
  <div>
    ...
    <div id="works" class="container post">
      <div class="work-card">
        ...
        <div class="card-top">
          <div class="banner img-up" style="background: url('/img/works/Machine.jpg')">
          ...
          <div class="banner img-mid" style="background: url('img/works/Machine.jpg')"></div>
          <div class="banner img-down" style="background: url('img/works/Machine.jpg')"></div>
        </div>
        <div class="card-content">
          <h3 class="card-name">3D 电气室实时监控系统</h3>
          <p class="card-desc">结合 Vue 框架，利用 Three.js 打造的可定时刷新的 3D 电气室</p>
        </div>
        </router-link>
      </div>
      ...
      <div class="work-card">
        ...
        <div class="card-top">
          ...
          <div class="banner img-down" style="background: url('img/works/Data.jpg')"></div>
        </div>
        <div class="card-content">
